    ...
    const maps = {
      planner: {
        ...
        ja: {
          ...
          '.home-cover-desk .section-desc':'最初の画面は入力フォームではなく、街のムードと sample route から始まるエディトリアルカバーとして整えました。',
        ...
        zhHant: {
          ...
          '.home-cover-desk .section-desc':'第一眼不是輸入表單，而是先用城市 mood 與 sample route 打開的 editorial cover。',
