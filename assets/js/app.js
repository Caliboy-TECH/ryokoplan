...
function getSeasonalEditorialCollections(){
  ...
  function renderHomeCommunityDesk(){
    ...
    if (!root) return;
    const copyMap = { ko:{eyebrow:'Route club', title:'에디터 픽과 다음 분기까지 한 번에 보기', desc:'도시를 고르는 것에서 끝내지 않고, 지금 잘 먹히는 베이스와 다음으로 연결되는 분기를 같이 보여줍니다.', picks:'Editor picks', trending:'Trending bases', branches:'Branch next', guide:'City guide', sample:'Sample route', save:'내 베이스로 쓰기'}, en:{eyebrow:'Route club', title:'See editor picks and next branches together', desc:'This does more than pick a city. It puts strong current bases and smoother next branches in one place.', picks:'Editor picks', trending:'Trending bases', branches:'Branch next', guide:'City guide', sample:'Sample route', save:'Use as my base'}, ja:{eyebrow:'Route club', title:'エディターピックと次の分岐を一緒に見る', desc:'都市を選ぶだけで終わらず、今よくはまるベースと次につながる分岐を一緒に見せます。', picks:'Editor picks', trending:'Trending bases', branches:'Branch next', guide:'City guide', sample:'Sample route', save:'自分のベースに使う'}, zhHant:{eyebrow:'Route club', title:'把 editor picks 和下一個分支一起看', desc:'不只幫你選城市，也把現在好用的 base 和接下來的分支一起放在這裡。', picks:'Editor picks', trending:'Trending bases', branches:'Branch next', guide:'City guide', sample:'Sample route', save:'存成我的 base'}};
