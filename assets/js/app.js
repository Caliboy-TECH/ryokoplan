      ...
      <section class="section editorial-dispatch-section magazine-dispatch-section">
        ...
        <div class="dispatch-edit-grid">
          <article class="dispatch-edit-card feature">
            ...
            <div class="cta-row"><button class="primary-btn" data-start-city="Tokyo">${lang === 'ko' ? '플래너로 시작' : lang === 'ja' ? 'Planner で始める' : lang === 'zhHant' ? '在 Planner 開始' : 'Start in Planner'}</button><a class="secondary-btn" href="../example/tokyo-3n4d-first-trip.html">${lang === 'ko' ? '샘플 보기' : lang === 'ja' ? 'サンプルを見る' : lang === 'zhHant' ? '看範例' : 'Read sample'}</a></div>
          </article>
...
function getSeasonalEditorialCollections(){
  ...
  const secondaryCityThinDepthMap = {
    osaka:{
      ko:{deeperTitle:'얇게 읽는 Osaka', deeperDesc:'첫 식사와 늦은 마감만 선명하게 두면 오사카는 훨씬 빨리 정리됩니다.', deeper:[['Nakanoshima side','도톤보리만으로 끝내지 않게 해 주는 quieter layer입니다.']], visitTitle:'가벼운 방문 분기', visitDesc:'첫 오사카는 food-first, 다시 가면 river/café layer가 더 좋습니다.', first:['Namba → Dotonbori → Umeda late','식사와 밤 장면 하나만 선명하게 두세요.'], second:['Nakanoshima → Utsubo → Umeda close','재방문이면 quieter west pocket이 더 오래 갑니다.'], entryTitle:'Thin entry routes', entryRoutes:[['Food-first opener','Namba → Dotonbori'],['Softer opener','Nakanoshima → Utsubo Park']]}},
      en:{deeperTitle:'A lighter Osaka read', deeperDesc:'Osaka gets clear quickly when the first meal line and the late close stay sharp.', deeper:[['Nakanoshima side','A quieter layer that stops the city from ending as only Dotonbori.']], visitTitle:'Light visit split', visitDesc:'A first Osaka can stay food-first; a return trip often lands better with a river-and-café layer.', first:['Namba → Dotonbori → Umeda late','Keep one meal line and one late scene vivid.'], second:['Nakanoshima → Utsubo → Umeda close','A quieter west-side pocket often lands better on a repeat trip.'], entryTitle:'Thin entry routes', entryRoutes:[['Food-first opener','Namba → Dotonbori'],['Softer opener','Nakanoshima → Utsubo Park']]}}
    },
    sapporo:{
      ko:{deeperTitle:'얇게 읽는 Sapporo', deeperDesc:'삿포로는 날씨와 넓은 거리 폭을 같이 읽을수록 더 편안하게 남습니다.', deeper:[['Maruyama side','중심지보다 한 단계 부드럽게 쉬어가기 좋은 pocket입니다.']], visitTitle:'가벼운 방문 분기', visitDesc:'첫 삿포로는 central axis, 다시 가면 calmer neighborhood가 더 좋습니다.', first:['Odori → Susukino → late soup curry','중심 축을 짧고 분명하게 읽으세요.'], second:['Maruyama → café pocket → Susukino close','재방문이면 quieter neighborhood가 더 잘 남습니다.'], entryTitle:'Thin entry routes', entryRoutes:[['Central opener','Odori → Susukino'],['Soft opener','Maruyama → café pocket']]}},
      en:{deeperTitle:'A lighter Sapporo read', deeperDesc:'Sapporo stays calmer when weather, width, and slower pacing are read together.', deeper:[['Maruyama side','A softer pause layer beyond the obvious central axis.']], visitTitle:'Light visit split', visitDesc:'The first read can stay central; the second usually lands better through a calmer neighborhood.', first:['Odori → Susukino → late soup curry','Keep the central line short and readable.'], second:['Maruyama → café pocket → Susukino close','A softer neighborhood layer often lands better on a repeat visit.'], entryTitle:'Thin entry routes', entryRoutes:[['Central opener','Odori → Susukino'],['Soft opener','Maruyama → café pocket']]}}
    },
    sendai:{
      ko:{deeperTitle:'얇게 읽는 Sendai', deeperDesc:'센다이는 큰 headline보다 잔잔한 거리 리듬으로 읽을 때 더 오래 남습니다.', deeper:[['Jozenji-dori side','센다이의 pace를 가장 쉽게 보여주는 축입니다.']], visitTitle:'가벼운 방문 분기', visitDesc:'첫 센다이는 station-centre 축, 다시 가면 tree-lined pocket이 더 좋습니다.', first:['Station → arcade → Jozenji-dori','이해 쉬운 축부터 열면 좋습니다.'], second:['Jozenji-dori → quiet coffee → river edge','재방문이면 더 느린 북측 pace가 잘 맞습니다.'], entryTitle:'Thin entry routes', entryRoutes:[['Centre opener','Station → arcade'],['Calm opener','Jozenji-dori → coffee pocket']]}},
      en:{deeperTitle:'A lighter Sendai read', deeperDesc:'Sendai lingers better through calm street rhythm than through headline stops.', deeper:[['Jozenji-dori side','One of the clearest ways to feel Sendai’s softer pace.']], visitTitle:'Light visit split', visitDesc:'The first read can stay centre-led; the second often works better through a calmer tree-lined pocket.', first:['Station → arcade → Jozenji-dori','Open through the clearest central line first.'], second:['Jozenji-dori → quiet coffee → river edge','A slower north-side rhythm often lands better on a return.'], entryTitle:'Thin entry routes', entryRoutes:[['Centre opener','Station → arcade'],['Calm opener','Jozenji-dori → coffee pocket']]}}
    },
    okinawa:{
      ko:{deeperTitle:'얇게 읽는 Okinawa', deeperDesc:'오키나와는 해안 뒤에 느린 pocket 하나를 붙일수록 결이 선명해집니다.', deeper:[['Yomitan side','리조트 축 뒤에 slower layer를 붙이기 좋은 쪽입니다.']], visitTitle:'가벼운 방문 분기', visitDesc:'첫 오키나와는 coast-first, 다시 가면 slower local pocket이 더 좋습니다.', first:['Coast drive → beach stop → sunset close','바다 축을 분명히 여세요.'], second:['Yomitan → café pocket → slower dusk','재방문이면 quieter west pocket이 더 오래 갑니다.'], entryTitle:'Thin entry routes', entryRoutes:[['Coast opener','Coast drive → beach stop'],['Slow opener','Yomitan → café pocket']]}},
      en:{deeperTitle:'A lighter Okinawa read', deeperDesc:'Okinawa becomes clearer when one slow pocket sits behind the coast line.', deeper:[['Yomitan side','A strong softer layer after the obvious resort line.']], visitTitle:'Light visit split', visitDesc:'The first read can stay coast-first; a return often lands better through a slower local pocket.', first:['Coast drive → beach stop → sunset close','Open the route clearly through the sea line.'], second:['Yomitan → café pocket → slower dusk','A quieter west-side layer often holds better on a repeat visit.'], entryTitle:'Thin entry routes', entryRoutes:[['Coast opener','Coast drive → beach stop'],['Slow opener','Yomitan → café pocket']]}}
    },
    jeju:{
      ko:{deeperTitle:'얇게 읽는 Jeju', deeperDesc:'제주는 scenic list보다 wind·coast·slower reset 결로 읽을수록 더 좋아집니다.', deeper:[['Aewol side','바람과 카페 리듬이 같이 남는 쉬운 pocket입니다.']], visitTitle:'가벼운 방문 분기', visitDesc:'첫 제주는 coast line, 다시 가면 slower west pocket이 더 좋습니다.', first:['Aewol → coast café → sunset','너무 많이 돌기보다 해안 결 하나만 남기세요.'], second:['Aewol → village pocket → slower close','재방문이면 느린 리셋 감이 더 중요합니다.'], entryTitle:'Thin entry routes', entryRoutes:[['Coast opener','Aewol → coast café'],['Reset opener','village pocket → slower west']]}},
      en:{deeperTitle:'A lighter Jeju read', deeperDesc:'Jeju lands better as wind, coast, and a slower reset than as only a scenic list.', deeper:[['Aewol side','An easy pocket where breeze, cafés, and west-coast rhythm sit together.']], visitTitle:'Light visit split', visitDesc:'A first Jeju can stay coast-led; a return often lands better through a slower west-side reset.', first:['Aewol → coast café → sunset','Keep one coast line vivid instead of over-rotating.'], second:['Aewol → village pocket → slower close','A slower reset usually matters more on a repeat visit.'], entryTitle:'Thin entry routes', entryRoutes:[['Coast opener','Aewol → coast café'],['Reset opener','village pocket → slower west']]}}
    },
    gyeongju:{
      ko:{deeperTitle:'얇게 읽는 Gyeongju', deeperDesc:'경주는 큰 유산 스폿보다 quiet heritage pace로 읽을수록 차별점이 살아납니다.', deeper:[['Hwangnidan-gil side','headline보다 생활감 있는 유산 결을 얇게 붙이기 좋습니다.']], visitTitle:'가벼운 방문 분기', visitDesc:'첫 경주는 주요 유산 축, 다시 가면 quieter lane이 더 좋습니다.', first:['Daereungwon → museum edge → dusk walk','가장 이해 쉬운 유산 축부터 여세요.'], second:['Hwangnidan-gil → quiet lane → dusk close','재방문이면 조용한 거리 결이 더 잘 남습니다.'], entryTitle:'Thin entry routes', entryRoutes:[['Heritage opener','Daereungwon → museum edge'],['Quiet opener','Hwangnidan-gil → lane walk']]}},
      en:{deeperTitle:'A lighter Gyeongju read', deeperDesc:'Gyeongju gets stronger when it is read as a quiet heritage pace instead of only headline sites.', deeper:[['Hwangnidan-gil side','A good pocket for adding everyday heritage texture beyond the obvious frame.']], visitTitle:'Light visit split', visitDesc:'The first read can stay heritage-led; a return often lands better through quieter lanes.', first:['Daereungwon → museum edge → dusk walk','Open through the clearest heritage line first.'], second:['Hwangnidan-gil → quiet lane → dusk close','A quieter lane rhythm often carries more memory on a repeat visit.'], entryTitle:'Thin entry routes', entryRoutes:[['Heritage opener','Daereungwon → museum edge'],['Quiet opener','Hwangnidan-gil → lane walk']]}}
    },
    macau:{
      ko:{deeperTitle:'얇게 읽는 Macau', deeperDesc:'마카오는 old lane과 night glow를 짧게 나눌수록 훨씬 더 또렷해집니다.', deeper:[['Taipa side','올드센터 뒤에 붙이면 너무 빽빽하지 않게 완충해 줍니다.']], visitTitle:'가벼운 방문 분기', visitDesc:'첫 마카오는 old street 중심, 다시 가면 Taipa 쪽이 더 좋습니다.', first:['Ruins edge → Senado → night glow','old lane과 밤 장면 하나만 분명히 두세요.'], second:['Taipa → old lane → softer close','재방문이면 더 compact하고 느슨한 축이 좋습니다.'], entryTitle:'Thin entry routes', entryRoutes:[['Old-lane opener','Ruins edge → Senado'],['Taipa opener','Taipa → softer lane']]}},
      en:{deeperTitle:'A lighter Macau read', deeperDesc:'Macau gets clearer once old lanes and night glow are split into two clean layers.', deeper:[['Taipa side','A softer buffer after the older core so the route does not stay too dense.']], visitTitle:'Light visit split', visitDesc:'The first read can stay old-street led; a return often lands better through Taipa.'], first:['Ruins edge → Senado → night glow','Keep one old-lane line and one late scene vivid.'], second:['Taipa → old lane → softer close','A more compact, looser route often works better on a repeat visit.'], entryTitle:'Thin entry routes', entryRoutes:[['Old-lane opener','Ruins edge → Senado'],['Taipa opener','Taipa → softer lane']]}}
    }
  };
