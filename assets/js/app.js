...
const exampleVariationPolishMap = {
  ...
  'osaka-2n3d-food-trip': { ko:[], en:[] },
  'sapporo-2n3d-winter-city': { ko:[], en:[] },
  'sendai-2n3d-calm-city': { ko:[], en:[] },
  'okinawa-3n4d-sea-reset': { ko:[], en:[] },
  'macau-2n3d-night-lanes': { ko:[], en:[] }
};
...
function getCityRouteVariations(slug){
  ...
  function getExampleCrossLinks(slug){
    ...
    const map = {
      ...
      'jeju-2n3d-slow-reset': ['okinawa-3n4d-island-breeze','busan-2n3d-with-parents'],
      'gyeongju-2n3d-heritage-walk': ['kyoto-2n3d-slow-trip','macau-2n3d-heritage-night'],
      ...
      'sapporo-2n3d-winter-city': ['sendai-2n3d-city-rest','tokyo-3n4d-first-trip'],
      'sendai-2n3d-calm-city': ['sapporo-3n4d-snow-soft','tokyo-3n4d-first-trip'],
