...
function getSeasonalEditorialCollections(){
  ...
  const exampleVariationPolishMap = {
    ...
    'taipei-3n4d-night-food': {
      ...
      en:[
        ['Rainy version','Cut the viewpoint count and let cafés, bookshops, and indoor meal pockets stretch longer. In Taipei, rain often makes the city richer because the alley texture and food layering become the main event.'],
    ...
    'hongkong-3n4d-harbor-rhythm': {
      ...
      en:[
        ['Rainy version','Reduce the number of viewpoints and lean more confidently on covered malls, ferry logic, and indoor meal pockets. Hong Kong still feels tall and compressed on gray days, so the route does not need to overcompensate.'],
