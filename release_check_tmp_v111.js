    const storageKey = 'ryoko:release-check-v111';
    ...
    window.addEventListener('storage', event => {
      if ([telemetryStorageKey, storageKey, startPathMemoryKey, startPathRecallDismissKey, quickResumeDismissKey, readingHistoryKey, readingHistoryDismissKey, plannerDraftKey, plannerDraftDismissKey, betaDismissKey, firstRunGuideKey].includes(event.key)) {
        loadChecks();
        renderTelemetry();
        updateReleaseReportPreview();
      }
