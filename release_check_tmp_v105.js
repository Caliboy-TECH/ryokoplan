    ...
    const storageKey = 'ryoko:release-check-v105';
    ...
    window.addEventListener('storage', event => {
      if ([telemetryStorageKey, storageKey, startPathMemoryKey, startPathRecallDismissKey, quickResumeDismissKey, readingHistoryKey, readingHistoryDismissKey, betaDismissKey, firstRunGuideKey].includes(event.key)) {
        loadChecks();
        renderTelemetry();
        updateReleaseReportPreview();
      }
